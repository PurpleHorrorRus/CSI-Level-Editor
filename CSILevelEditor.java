...
public class CSILevelEditor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Roguelike CSI Level Editor by Nikiforoff.tk (Version from 04/11/15)");
        setResizable(false);
                ...
                try {
                    ...
                    for(int i = 0; i < jTable1.getModel().getRowCount(); i++){
                        for(int b = 0; b < jTable1.getModel().getColumnCount(); b++){
                            String data = (String) jTable1.getModel().getValueAt(i,b); // col(b) - x, row(i) - y
                    ...
                    try {
                        ...
                        Logger.getLogger(CSILevelEditor.class.getName()).log(Level.SEVERE, null, ex);
                    }
        ...
        jLabel2.setText("The starting position");
...
class ShowCode extends javax.swing.JFrame {
